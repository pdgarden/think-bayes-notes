...
Notes taken while reading [Think Bayes](https://allendowney.github.io/ThinkBayes2/) by Allen B. Downey.  
- Jupyter notebook and quarto are used to render the report from file `think_bayes_notes.ipynb`.  
